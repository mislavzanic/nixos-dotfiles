...
Gem::Specification.new do |s|
  ...
  s.metadata = { "homepage_uri" => "https://github.com/seattlerb/graph" } if s.respond_to? :metadata=
  ...
  s.files = ["History.txt".freeze, "Manifest.txt".freeze, "README.txt".freeze, "bin/graph".freeze]
