# -*- encoding: utf-8 -*-
# stub: rspec-terraspace 0.3.1 ruby lib

Gem::Specification.new do |s|
  s.name = "rspec-terraspace".freeze
  s.version = "0.3.1"
  ...
  s.homepage = "https://github.com/boltops-tools/rspec-terraspace".freeze
  s.licenses = ["Apache-2.0".freeze]
  s.required_ruby_version = Gem::Requirement.new(">= 2.3.0".freeze)
  s.rubygems_version = "3.2.26".freeze
  s.summary = "Terraspace RSpec support".freeze
