...
xmobarPath :: String
xmobarPath = "~/.config/.dotfiles/config/xmobar/xmobarrc"

barSpawner :: ScreenId -> StatusBarConfig
barSpawner = \case
  0 -> statusBarPropTo "_XMONAD_LOG_0" "xmobar -x 0 ~/.config/.dotfiles/config/xmobar/xmobarrc0" (xmobarPP 0)
  1 -> statusBarPropTo "_XMONAD_LOG_1" "xmobar -x 1 ~/.config/.dotfiles/config/xmobar/xmobarrc1" (xmobarPP 1)
  _ -> mempty
